...
def ping():
	...
	try:
		...
		s.close()
		# closing the connection after the communication with the server is completed
		return True


def calculate_time(start, stop):

	# calculating unavailability time and converting it in seconds
...
def main():
	...
	with open(FILE, "a") as file:
		...
		# write into the file as a into networkinfo.log, "a" - append: opens file for appending,
	...
	while True:
		...
		# infinite loop, as we are monitoring the network connection till the machine runs
		if ping():
			...
			with open(FILE, "a") as file:
				...
				# log entry for connection restoration time, and unavailability time
